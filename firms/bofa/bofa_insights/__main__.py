"""CLI: `python -m bofa_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="bofa_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Bank of America Insights dashboard → http://{args.host}:{args.port}\n")
