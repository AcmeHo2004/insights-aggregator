"""CLI: `python -m apollo_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="apollo_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Apollo Insights dashboard → http://{args.host}:{args.port}\n")
