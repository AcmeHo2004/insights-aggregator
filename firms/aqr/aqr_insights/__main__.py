"""CLI: `python -m aqr_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="aqr_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  AQR Insights dashboard → http://{args.host}:{args.port}\n")
