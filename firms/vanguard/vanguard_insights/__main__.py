"""CLI: `python -m vanguard_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="vanguard_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Vanguard Insights dashboard → http://{args.host}:{args.port}\n")
