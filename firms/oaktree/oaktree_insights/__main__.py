"""CLI: `python -m oaktree_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="oaktree_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Oaktree Insights dashboard → http://{args.host}:{args.port}\n")
