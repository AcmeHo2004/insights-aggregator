"""CLI: `python -m rbc_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="rbc_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  RBC Capital Markets Insights dashboard → http://{args.host}:{args.port}\n")
