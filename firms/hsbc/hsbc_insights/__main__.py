"""CLI: `python -m hsbc_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="hsbc_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  HSBC Insights dashboard → http://{args.host}:{args.port}\n")
