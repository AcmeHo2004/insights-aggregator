"""CLI: `python -m capitalgroup_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="capitalgroup_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Capital Group Insights dashboard → http://{args.host}:{args.port}\n")
