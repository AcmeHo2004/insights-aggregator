"""CLI: `python -m schroders_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="schroders_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Schroders Insights dashboard → http://{args.host}:{args.port}\n")
