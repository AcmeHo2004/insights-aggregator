"""CLI: `python -m nomura_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="nomura_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Nomura Insights dashboard → http://{args.host}:{args.port}\n")
