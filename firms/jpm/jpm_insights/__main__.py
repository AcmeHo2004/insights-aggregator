"""CLI: `python -m jpm_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="jpm_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  JPM Insights dashboard → http://{args.host}:{args.port}\n")
