"""CLI: `python -m wellington_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="wellington_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Wellington Insights dashboard → http://{args.host}:{args.port}\n")
