"""CLI: `python -m gmo_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="gmo_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  GMO Insights dashboard → http://{args.host}:{args.port}\n")
