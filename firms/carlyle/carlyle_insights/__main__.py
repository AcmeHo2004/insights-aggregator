"""CLI: `python -m carlyle_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="carlyle_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Carlyle Insights dashboard → http://{args.host}:{args.port}\n")
