"""CLI: `python -m gs_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="gs_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Goldman Sachs Insights dashboard → http://{args.host}:{args.port}\n")
