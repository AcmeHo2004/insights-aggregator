"""CLI: `python -m doubleline_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="doubleline_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  DoubleLine Insights dashboard → http://{args.host}:{args.port}\n")
