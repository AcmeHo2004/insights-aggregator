"""CLI: `python -m deutschebank_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="deutschebank_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Deutsche Bank Insights dashboard → http://{args.host}:{args.port}\n")
