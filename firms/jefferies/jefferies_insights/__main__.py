"""CLI: `python -m jefferies_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="jefferies_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Jefferies Insights dashboard → http://{args.host}:{args.port}\n")
