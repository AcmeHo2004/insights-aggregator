"""CLI: `python -m neubergerberman_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="neubergerberman_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Neuberger Berman Insights dashboard → http://{args.host}:{args.port}\n")
