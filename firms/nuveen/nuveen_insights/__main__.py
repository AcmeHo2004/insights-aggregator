"""CLI: `python -m nuveen_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="nuveen_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Nuveen Insights dashboard → http://{args.host}:{args.port}\n")
