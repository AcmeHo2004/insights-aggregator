"""CLI: `python -m pimco_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="pimco_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  PIMCO Insights dashboard → http://{args.host}:{args.port}\n")
