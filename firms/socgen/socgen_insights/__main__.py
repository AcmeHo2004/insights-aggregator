"""CLI: `python -m socgen_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="socgen_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Société Générale Insights dashboard → http://{args.host}:{args.port}\n")
