...
Morgan Stanley: podcasts via `rss`; morganstanley.com + MSIM written insights via the generic
`sitemap_articles` adapter (public sitemaps + og: metadata).
"""
...
# Browser-like UA: morganstanley.com returns 403 to non-browser agents (and 301-redirects
# its podcast feed to a Megaphone-hosted URL, which httpx then follows).
USER_AGENT = (
