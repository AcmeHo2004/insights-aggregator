"""CLI: `python -m ms_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="ms_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Morgan Stanley Insights dashboard → http://{args.host}:{args.port}\n")
