"""CLI: `python -m blackstone_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="blackstone_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Blackstone Insights dashboard → http://{args.host}:{args.port}\n")
