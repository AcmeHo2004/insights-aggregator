"""CLI: `python -m janushenderson_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="janushenderson_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Janus Henderson Insights dashboard → http://{args.host}:{args.port}\n")
