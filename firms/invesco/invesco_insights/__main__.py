"""CLI: `python -m invesco_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="invesco_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Invesco Insights dashboard → http://{args.host}:{args.port}\n")
