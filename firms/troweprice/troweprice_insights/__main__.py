"""CLI: `python -m troweprice_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="troweprice_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  T. Rowe Price Insights dashboard → http://{args.host}:{args.port}\n")
