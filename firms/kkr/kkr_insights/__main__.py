"""CLI: `python -m kkr_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="kkr_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  KKR Insights dashboard → http://{args.host}:{args.port}\n")
