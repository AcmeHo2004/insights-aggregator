"""CLI: `python -m bnpparibas_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="bnpparibas_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  BNP Paribas Insights dashboard → http://{args.host}:{args.port}\n")
