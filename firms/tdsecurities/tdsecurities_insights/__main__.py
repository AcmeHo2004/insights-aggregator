"""CLI: `python -m tdsecurities_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="tdsecurities_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  TD Securities Insights dashboard → http://{args.host}:{args.port}\n")
