"""CLI: `python -m barclays_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="barclays_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Barclays Insights dashboard → http://{args.host}:{args.port}\n")
