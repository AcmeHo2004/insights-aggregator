"""CLI: `python -m blk_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="blk_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  BlackRock Insights dashboard → http://{args.host}:{args.port}\n")
