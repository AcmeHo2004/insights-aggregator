"""CLI: `python -m ares_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="ares_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Ares Insights dashboard → http://{args.host}:{args.port}\n")
