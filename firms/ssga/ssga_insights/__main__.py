"""CLI: `python -m ssga_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="ssga_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  State Street Insights dashboard → http://{args.host}:{args.port}\n")
