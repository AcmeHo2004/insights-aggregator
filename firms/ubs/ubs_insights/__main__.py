"""CLI: `python -m ubs_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="ubs_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  UBS Insights dashboard → http://{args.host}:{args.port}\n")
