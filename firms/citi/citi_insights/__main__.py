"""CLI: `python -m citi_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="citi_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Citi Insights dashboard → http://{args.host}:{args.port}\n")
