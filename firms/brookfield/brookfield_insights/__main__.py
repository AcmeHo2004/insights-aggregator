"""CLI: `python -m brookfield_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="brookfield_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Brookfield Insights dashboard → http://{args.host}:{args.port}\n")
