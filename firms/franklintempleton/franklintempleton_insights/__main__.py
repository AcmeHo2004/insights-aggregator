"""CLI: `python -m franklintempleton_insights {scan|serve}`."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="franklintempleton_insights", description=__doc__)
    ...
    if args.command == "serve":
        ...
        print(f"\n  Franklin Templeton Insights dashboard → http://{args.host}:{args.port}\n")
