...
Podcasts via `rss`; corporate written insights via the generic
...
# Browser-like UA: many corporate sites return 403 to non-browser agents, and
# some podcast feeds 30x-redirect to their host CDN, which httpx then follows.
USER_AGENT = (
